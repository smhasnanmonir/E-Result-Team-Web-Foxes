...
const UpdateProfile = () => {
    ...
    const onSubmit = data => {
        axiosSecure.patch('/updateUser', data)
        .then(res =>{
    ...
    <div>
      <div className='text-center'>
            ...
            <div className='flex flex-col lg:flex-row  justify-center items-center gap-3'>
                ...
                <form className='flex flex-col justify-center items-center px-2 max-w-lg w-full' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='text-center'>
                        <div className='flex flex-col md:flex-row justify-center items-center gap-5'>
                            <div className="form-control w-full ">
                                ...
                                <input className="input input-bordered border-green-400 w-full" type="email" value={user?.email} {...register("email",  {required:true})} />
                            </div>
                            ...
                            <div className="form-control w-full ">
                                ...
                                <input className="input input-bordered border-green-400 w-full " type="text" placeholder="Name" {...register("name", {})} />
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col md:flex-row justify-center items-center gap-5'>
                            <div className="form-control w-full ">
                                    ...
                                    <input className="input input-bordered border-green-400 w-full " type="number" placeholder="Enter Age" {...register("age", {})} />
                            </div>
                        ...
                        <div className='flex flex-col md:flex-row justify-center items-center gap-5'>
                            <div className="form-control w-full ">
                                    ...
                                    <input className="input input-bordered border-green-400 w-full " type="number" placeholder="Phone" {...register("phone", {})} />
                            </div>
                            ...
                            <div className="form-control w-full ">
                                    ...
                                    <select {...register("gender")} className="select select-bordered border-green-400 w-full max-w-xs">
                        ...
                        <div className="form-control w-full">
                                ...
                                <textarea rows='5' className="input input-bordered border-green-400 w-full h-full " placeholder='Type your address' {...register("home", {})} />
                        </div>
                    </div>
