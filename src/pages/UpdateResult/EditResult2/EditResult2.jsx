...
const EditResult2 = () => {
    ...
    return (
        ...
        <div className="f-form lg:flex gap-5 w-[80%] mx-auto">
           <input type="search" name="search1" id="search1" placeholder="Search Box(Name)"/> 
        ...
        <div className="bg-green-100 py-10 rounded lg:w-[80%] lg:mx-auto shadow-xl">
            <div>
                    <div className="ml-auto w-[200px]">
                        ...
                        <select className="rounded" id="trimSelect" value={selectedTrim} onChange={handleTrimChange}>
                    ...
                    <div className="my-5">
                        {
                                selectedTrim === 'midtrim' ? <Midtrim></Midtrim>:<FinalTrim></FinalTrim>
                        }
                    </div>
                </div>
</div>
