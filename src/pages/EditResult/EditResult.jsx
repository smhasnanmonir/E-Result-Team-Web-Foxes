      ...
      <div className="">
        ...
        <div className="modal">
          <div className="modal-box">
            <div className="">
              <div className="text-center bg-green-200 p-5 text-[16px] rounded">
              ...
              <div >
              <form onSubmit={handleSubmit(onSubmit)} className="text-center bg-green-200 p-5 text-[16px] rounded my-5 grid grid-cols-3 gap-7">
            <div className="mt-5">
